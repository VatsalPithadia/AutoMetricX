  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-xl p-8 sm:p-10 text-center transition-all cursor-pointer bg-white ${isDragging ? 'border-emerald-600 bg-emerald-50/50' : 'border-gray-300 hover:border-gray-400'
          }`}
      >
        <div className="space-y-1.5 mb-5">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 text-gray-700 mb-2.5">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <button
            type="button"
            className="px-5 py-2.5 rounded-lg bg-gray-900 text-white font-semibold text-sm hover:bg-gray-800 transition-colors cursor-pointer shadow-xs"
          >
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg bg-white border border-gray-300 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors cursor-pointer shadow-xs"
          >
            Snap with Camera
          </button>
          ...
          <button
            ...
            className="px-3 py-2 text-xs text-gray-500 hover:text-red-700 underline transition-colors cursor-pointer"
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4 shadow-sm">
          ...
          <div className="flex items-center justify-between pb-3.5 border-b border-gray-100">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs uppercase font-mono font-bold px-2.5 py-1 rounded bg-emerald-100 text-emerald-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5">
            {selectedImages.map((img, idx) => (
              ...
              >
                {/* Header tag */}
                <div className="p-2.5 bg-white border-b border-gray-100 flex items-center justify-between text-sm">
                  <span className="font-bold text-gray-800">
                    Side {idx + 1}: <span className="text-gray-500 font-normal">{img.label}</span>
                  </span>
                  <button
                    onClick={() => removeImage(img.id)}
                    className="text-gray-400 hover:text-red-600 font-bold px-1.5 py-0.5 rounded text-sm"
                ...
                {/* Thumbnail */}
                <div className="h-44 flex items-center justify-center p-2 bg-gray-100">
                  <img
                    src={img.previewUrl}
                    alt={img.name}
                ...
                {/* Meta footer */}
                <div className="p-2.5 bg-white text-xs text-gray-500 flex items-center justify-between border-t border-gray-100 font-mono">
          ...
          {selectedImages.length > 1 && (
            <div className="p-3.5 bg-emerald-50/70 border border-emerald-200 rounded-lg text-sm text-emerald-900 flex items-center gap-2.5">
              <span className="font-bold shrink-0">✓ Multi-Angle Audit:</span>
              <span>
          ...
          <div className="flex justify-end pt-2">
            <button
              onClick={onStartScan}
              disabled={isScanning}
              className="w-full sm:w-auto px-8 py-3.5 rounded-lg bg-gray-900 hover:bg-gray-800 text-white font-bold text-sm tracking-wide transition-all cursor-pointer disabled:opacity-50 shadow-sm"
            >
