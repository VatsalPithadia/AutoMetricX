      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <span className="text-lg font-extrabold text-gray-900 tracking-tight">Auto MatriX</span>
          ...
          <nav className="flex items-center gap-1 bg-gray-100 p-1 rounded-lg">
            <button
              ...
              className={`px-3 py-1 text-xs font-semibold rounded transition-colors cursor-pointer ${currentNav === 'scan' ? 'bg-white text-gray-900 shadow-xs' : 'text-gray-600 hover:text-gray-900'
                }`}
            >
              New Scan
            </button>
            <button
              ...
              className={`px-3 py-1 text-xs font-semibold rounded transition-colors cursor-pointer ${currentNav === 'history' ? 'bg-white text-gray-900 shadow-xs' : 'text-gray-600 hover:text-gray-900'
                }`}
            >
              Past Audits
            </button>
